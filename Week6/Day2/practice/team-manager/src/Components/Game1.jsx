...
<table className="table table-striped table-bordered">
            ...
            return(
                ...
                <td>
                <div >
                <button style={{margin:"10px"}} type="button" class={`btn ${checkStatusPlaying(player.status[0])}`} onClick={(e)=>updatePlayer(player._id,"Playing",player.status)}  >Playing</button>
                <button style={{margin:"10px"}} type="button" class={`btn ${checkStatusNPlaying(player.status[0])}`} onClick={(e)=>updatePlayer(player._id,"Not Playing",player.status)}>Not Playing</button>
                <button style={{margin:"10px"}} type="button" class={`btn ${checkStatusUndecided(player.status[0])}`}onClick={(e)=>updatePlayer(player._id,"Undecided",player.status)} >Undecided</button>
